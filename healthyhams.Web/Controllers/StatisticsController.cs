...
namespace healthyhams.Web.Controllers
{
    public class StatisticsController : Controller
    {
        ...
        public StatisticsController(IUserData db, healthyhamsContext context)
        {
            this.db = db;
        ...
        public void generatePdf()
        {
            ...
            FileStream imageStream = new FileStream("healthyhams-logo.png", FileMode.Open, FileAccess.Read);
